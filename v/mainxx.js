...
var SongAudio = new Audio("https://editor-miring-squad.netlify.app/mix/mk-anime-song.mp3");
SongAudio.loop = false;
SongAudio.autoplay = false;
...
function OpenImgA() {
  window.location.replace("https://editor-miring-squad.netlify.app/assets/images/TNG.jpg");
  klik.play();
}
function OpenImgB() {
  window.location.replace("https://editor-miring-squad.netlify.app/assets/images/tca.jpg");
  klik.play();
}
function OpenMenu() {
